...
\- \*\*No external heavy dependencies\*\* (only `stb\_image` for image I/O).
...
&nbsp; - Zero-Crossing (`zc\_LoG`) for 1-pixel thin, mathematically accurate continuous edges.

\- \*\*Filtering \& Manipulation:\*\*

&nbsp; - Iterative Binomial Blur (`f\_bin\_blur`)
...
&nbsp;   ImageG thin\_edges = gray.zc\_LoG(5, 15.0f);

&nbsp;   

&nbsp;   // Save result

&nbsp;   thin\_edges.save("output\_edges.jpg");
